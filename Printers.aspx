...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>
        &nbsp;</p>
    <p>
        <asp:SqlDataSource ID="SqlDataSourceLaptops" runat="server" ConnectionString="<%$ ConnectionStrings:myConnectionString %>" ProviderName="<%$ ConnectionStrings:myConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [Product] WHERE ([category]='Printer')"></asp:SqlDataSource>
    </p>
    <p>
        &nbsp;</p>
        </form>
